...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-xl bg-slate-950/80 border-b border-cyan-500/20">
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        ...
                        <button
                            className="px-6 py-2.5 rounded-xl border border-cyan-400 text-cyan-400
                            hover:bg-cyan-400 hover:text-slate-950 transition duration-300
                        ...
                        <button
                            className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-400
                            to-violet-600 text-white hover:scale-105 transition duration-300
                            shadow-[0_0_25px_rgba(0,194,255,0.5)]"
            ...
            {/* Mobile Menu */}
            <div
                className={`md:hidden bg-slate-950/95 backdrop-blur-xl overflow-hidden
                ...
                <div className="px-6 py-5 space-y-5">
                    ...
                    {menuItems.map((item) => (
                        <button
                            key={item.id}
                            onClick={() => handleScroll(item.id)}
                            className="block w-full text-left text-slate-300
                    ...
                    <div className="flex flex-col gap-3 pt-3">
                        ...
                        <button
                            className="py-3 rounded-xl border border-cyan-400 text-cyan-400
                        ...
                        <button
                            className="py-3 rounded-xl bg-gradient-to-r from-cyan-400
